...
#+end_src
** Elm
node 18 don't seem to work, downgrade to node 16:
https://github.com/elm-tooling/elm-language-server/issues/692
might need to specify the elm workspace folder to be at the elm project root with =elm-stuff=
https://github.com/elm-tooling/elm-language-server/issues/305
#+begin_src emacs-lisp
